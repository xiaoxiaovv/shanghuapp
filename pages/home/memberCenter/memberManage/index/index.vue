...
<script>
	...
	export default {
		...
		onNavigationBarButtonTap (obj) {
			...
			// console.log(obj)
			uni.navigateTo({
				url: '/packageA/pages/home/memberCenter/memberManage/registeredMember/registeredMember'
			}) 
		},
		/* 搜索栏事件，文本变化触发 */
		...
		methods: {
			...
			memberJump (id) {
				uni.navigateTo({
					url: '/packageA/pages/home/memberCenter/memberManage/membershipDetails/membershipDetails?id='+id
				})
			},
			/* 获取会员列表 */
			getMemberLists() {
