<template>
	<!-- <view>
		<web-view ref="webview"  src='http://test.fx.mamipay.com/h5/#/clientEdit' ></web-view>
	</view> -->
</template>
...
<script>
	export default {
		...
		// let url ='http://test.fx.mamipay.com/h5/#/clientEdit';
		let url ='http://192.168.0.102:8088/#/clientEdit';
		let wv = plus.webview.create( url,'mendMerchant', {
			top:'66px',
			height:'92%',
		},{data:this.userInfo})
